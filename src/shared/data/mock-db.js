  ...
  blogPosts: [
    {
      ...
      content: {
        ru: "Эта публикация наглядно показывает, во сколько мне обошлось отсутствие дисциплины. При изучении нового необходима система. Без нее трудно отличить важное от второстепенного или продуктивную работу от непродуктивной. Грамотно выстроенная система помогает экономить время и силы в процессе обучения, расставлять приоритеты (сосредотачиваясь на первоочередных задачах) и поддерживать порядок в полученных знаниях. Система неоценима, когда нужно пройти незнакомый путь с минимумом ошибок; она подобна карте обширной территории. Создание такой системы требует дисциплины. Результаты не приходят в одночасье: чтобы овладеть какой-либо областью, необходима долгосрочная вовлеченность. При этом речь идет не просто о том, чтобы «убить время»; как я уже упоминал, требуется именно работа в рамках системы. Я читал материалы и смотрел контент о дисциплине, но не осознавал в полной мере ее важности. Лишь потратив уйму времени и энергии на мелкие задачи, в погоне за сиюминутными результатами и дофаминовым подкреплением, а также пройдя через множество часов непродуктивной и изматывающей работы, я наконец понял ее истинное значение. Может показаться, что понятия «система» и «дисциплина» здесь смешиваются, но это не так. Они дополняют друг друга. Я просто затрагиваю тему системы, когда представляется такая возможность. Этот опыт помог мне осознать, насколько важно подходить к работе с прицелом на долгосрочную перспективу.",
        ...
        en: "This blog post illustrates just how costly my lack of discipline has been. When learning something new, one needs a system. Without a system, it is difficult to distinguish the important from the trivial, or productive work from unproductive work. A well-structured system helps us save time and effort in the learning process, prioritize tasks—focusing on what needs to be done first—and keep what we learn organized. A system is invaluable for navigating an unfamiliar path with minimal errors; it is akin to having a map of a vast territory. Establishing such a system requires discipline. We do not achieve results overnight; mastering a field requires long-term commitment. This engagement shouldn't just be about passing time; as I mentioned earlier, it requires working within a system. I had read about and watched content regarding discipline, yet I hadn't truly grasped its importance. It was only after spending excessive time and energy on minor tasks, chasing short-term results and dopamine hits, and enduring a great deal of unproductive, frustrating work that I finally understood its significance. Reading this, it might seem like the concepts of 'system' and 'discipline' are being conflated, but that is not the case. The two complement each other. I also touched upon the system when the opportunity arose. Through this experience, I realized the importance of taking a long-term perspective in my work."
      },
      readTime: {
        ru: "2 мин",
        uz: "2 daqiqa",
